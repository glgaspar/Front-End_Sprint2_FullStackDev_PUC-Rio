      ...
      <div className="md:col-span-10 col-span-4 grid md:grid-cols-10 grid-cols-4 md:col-start-2 bg-component-whitesmoke rounded-xl mb-15">
        ...
        <div className="mt-5 ml-5 mr-5 md:col-span-10 grid md:grid-cols-13 col-span-4 grid-cols-1 gap-5">
          <div name="div" className="md:col-span-2 grid">
            ...
            <p name="Vendedor" className="p-2 w-4/5">
        ...
        >
          ...
          <div className="md:col-span-1 col-span-2">
            <label htmlFor="Valor">
              ...
              <p className="pt-2">
                {qtd &&
                  handleVl(qtd)?.toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })}
              </p>
          ...
          {itens &&
            itens.map((item, index) => {
              return (
                <div
                  key={index}
                  className="md:col-span-10 col-span-4 grid grid-cols-[95%_5%] md:grid-cols-10 md:gap-5"
                >
                  <div className="md:col-span-9">
                    <CardItem data={item} />
                  </div>
                  <div className="md:col-span-1 grid md:mt-5">
                    <button
                      className="text-right text-accent-orange"
